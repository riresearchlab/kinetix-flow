...
const ROICalculator = () => {
  ...
  const co2Factor = 0.42; // kg CO2 per kWh (US avg)
  const annualCo2Avoided = (annualSavedKwh * co2Factor) / 1000; // metric tons

  const InputSlider = ({ label, value, onChange, min, max, step, unit }: any) => (
    <div className="mb-6">
      <div className="flex justify-between items-center mb-2">
        <span className="text-sm text-muted-foreground">{label}</span>
        <span className="text-sm font-mono text-primary">{typeof value === 'number' && value < 1 ? value.toFixed(2) : value.toLocaleString()}{unit}</span>
      </div>
      <input
        type="range"
        min={min}
        ...
        style={{ accentColor: 'hsl(180, 100%, 41%)' }}
      />
    </div>
  );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            ROI <span className="text-teal text-glow">Calculator</span>
          </h2>
          <p className="text-muted-foreground">Estimate your annual savings and carbon offset</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            <div className="flex items-center gap-2 mb-8">
              ...
              <h3 className="text-lg font-semibold">Facility Parameters</h3>
            </div>
          ...
          >
            <div>
              <div className="flex items-center gap-2 mb-8">
                ...
                <h3 className="text-lg font-semibold">Projected Annual Impact</h3>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="glass-card rounded-xl p-5">
                  ...
                  <div className="text-4xl font-bold font-mono text-primary text-glow">
